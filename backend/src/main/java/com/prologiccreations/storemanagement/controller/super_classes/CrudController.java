package com.prologiccreations.storemanagement.controller.super_classes;

import com.prologiccreations.storemanagement.dto.Response;
import com.prologiccreations.storemanagement.model.super_classes.BaseEntity;
...
public interface CrudController<E extends BaseEntity, I> {
    ...
    @GetMapping(value = {"/list", "/list/{pageNumber}/{pageSize}", "/list/{pageNumber}/{pageSize}/{sortDirection}/{sortColumns}"}, produces = APPLICATION_JSON_VALUE)
